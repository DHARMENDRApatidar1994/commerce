...
const LatestCourseOverview = (props) => {
   // const [item, setItem] = useState(gallery)
   // const navigate = useNavigate();
   const { id } = useParams();
   // console.log(id);
   const obj = latest[id];
   const {addItem} = useCart(obj)
   console.log(addItem)
  return (
    <div>
      <Navbar/>
            ...
            <div className="CoursesOver">
               ...
               <div className="CourBtm">
                    ...
                    <div className="CourBtmRight">
                           ...
                           <div className="four d-flex flex-column">
                              <button>Enroll now</button>
                              <h4 onClick={addItem}  className='bg-light w-100 text-light p-2 rounded text-dark text-primary'>{obj.cart}</h4>
                           </div>
                    </div> 
               </div>         
</div>
...
export default LatestCourseOverview